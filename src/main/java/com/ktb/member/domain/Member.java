...
/**
 * @NoArgsConstructor
 *  JdbcTemplate 단계에서 BeanPropertyRowMapper / DataClassRowMapper 같은
 ...
 *
 * @AllArgsConstructor
 *  JdbcMemberRepository의 람다 RowMapper에서 new Member(...)로 매핑하기 위해 열어둠
...
/**
 * @Getter
 *  도메인 객체는 필드를 직접 노출하지 않고 메서드로 읽도록 캡슐화
 *  @Setter는 의도적으로 두지 않음
